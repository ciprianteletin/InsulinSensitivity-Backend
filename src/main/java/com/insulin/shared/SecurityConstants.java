...
public class SecurityConstants {
    ...
    public static final int RESET_PASSWORD_LIFE = 10_800;
    ...
    public static final String[] PUBLIC_URLS = {"/login", "/register", "/autologin", "/forgetPassword",
            "/resetPassword", "/user/resetPassword/**", "/user/image/**"}; //url-uri ce nu vor fi blocate de security
}
