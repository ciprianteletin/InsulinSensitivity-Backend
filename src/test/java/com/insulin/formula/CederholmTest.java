...
import com.insulin.formula.index.Cederholm;
...
public class CederholmTest {
    private final FormulaMarker formulaMarker = new Cederholm();
    ...
    public void test_nullWeight() {
        ...
        assertThat(exception.getMessage()).isEqualTo("Expected value for field weight used for index Cederholm");
    }
    ...
    public void test_withDefaultMgUi() {
        ...
        assertThat(result.getResult()).isEqualTo(30.1637);
    }
    ...
    public void test_diabetes() {
        ...
        assertThat(result.getResult()).isEqualTo(32.6608);
        assertThat(result.getSeverity()).isEqualTo(Severity.DIABETES);
        assertThat(result.getMessage()).isEqualTo("Type two diabetes");
        assertThat(result.getNormalRange()).isEqualTo("79±14");
    }

    @Test
    public void test_excelFormula() {
        assertThat(formulaMarker.generateExcelFormula(1))
                .isEqualTo("(75000 + (General!F3-General!J3)* 1.15 * 180 * 0.19 *General!Q3)/(120 * AVERAGE(General!F3:General!H3,General!J3)*LN(AVERAGE(General!L2:General!N2,General!P2)))");
    }
}
