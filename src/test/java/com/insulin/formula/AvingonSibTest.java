...
import com.insulin.formula.index.AvingonSib;
...
public class AvingonSibTest {
    private final FormulaMarker formulaMarker = new AvingonSib();
    ...
    public void test_withDefaultMgUi() {
        ...
        assertThat(result.getResult()).isEqualTo(1920000.0);
    }
    ...
    public void test_excelFormula() {
        assertThat(formulaMarker.generateExcelFormula(1))
                .isEqualTo("100000000 /(General!F3 * General!L2 * 150/General!Q3)");
    }
}
